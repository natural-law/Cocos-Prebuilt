...
class ModuleOrganizer(object):
    ...
    def handle_for_android(self, module_info):
        ...
        copy_android_lib_cfg["from"] = "prebuilt/android"
        ...
        excopy.copy_files_with_config(copy_android_lib_cfg, self.src_root, self.dst_root)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', "--src-root", dest='src_root', help='The root directory of prebuilt engine.')
    ...
    organizer = ModuleOrganizer(args.src_root, args.dst_root)
